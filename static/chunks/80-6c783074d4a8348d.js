  ...
  [80],
  {
    ...
    2082: (t, e, i) => {
      ...
      function r(t = !0) {
        ...
        let h = (0, n.useCallback)(() => t && a && a(l), [l, a, t]);
        return !i && a ? [!1, h] : [!0];
      }
    },
    2596: (t, e, i) => {
      i.d(e, { A: () => n });
      let n = function () {
        for (var t, e, i = 0, n = "", s = arguments.length; i < s; i++)
          (t = arguments[i]) &&
            (e = (function t(e) {
              var i,
                n,
    ...
    2605: (t, e, i) => {
      ...
      let v = (t) => (e) => "string" == typeof e && e.startsWith(t),
        x = v("--"),
        w = v("var(--"),
        T = (t) => !!w(t) && P.test(t.split("/*")[0].trim()),
        P =
          /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
      function b({ top: t, left: e, right: i, bottom: n }) {
      ...
      function M({ scale: t, scaleX: e, scaleY: i }) {
        return !A(t) || !A(e) || !A(i);
      }
      function E(t) {
        return (
      ...
      let B = new Set([
        ...
        q = (t) => (e) => e.test(t),
        G = [I, z, Y, W, X, H, { test: (t) => "auto" === t, parse: (t) => t }],
        _ = (t) => G.find(q(t)),
        Z = () => {},
        Q = () => {},
        J = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t),
      ...
      function th(t, e) {
        ...
        return {
          ...
          cancel: (t) => {
            for (let e = 0; e < to.length; e++) a[to[e]].cancel(t);
          },
          state: s,
          steps: a,
        };
      ...
      function tv() {
        ...
        (tg = !1), (tf = !1), tm.forEach((t) => t.complete(ty)), tm.clear();
      }
      function tx() {
        tm.forEach((t) => {
          t.readKeyframes(), t.needsMeasurement && (tg = !0);
        });
      }
      class tw {
        ...
        scheduleResolve() {
          (this.state = "scheduled"),
            this.isAsync
              ? (tm.add(this),
                tf || ((tf = !0), tu.read(tx), tu.resolveKeyframes(tv)))
        ...
        cancel() {
          "scheduled" === this.state &&
            (tm.delete(this), (this.state = "pending"));
        }
        resume() {
          "pending" === this.state && this.scheduleResolve();
        }
      }
      let tT = (t) => /^0[^.\s]+$/u.test(t),
        ...
        tE = (t) => O(0, 255, t),
        tV = { ...I, transform: (t) => Math.round(tE(t)) },
        tC = {
          test: tA("rgb", "red"),
        ...
        tR = {
          test: (t) => tC.test(t) || tD.test(t) || tk.test(t),
          parse: (t) =>
            tC.test(t) ? tC.parse(t) : tk.test(t) ? tk.parse(t) : tD.parse(t),
          transform: (t) =>
            "string" == typeof t
              ? t
        ...
        let e = t.toString(),
          ...
          a = e
            .replace(
              ...
              (t) => (
                tR.test(t)
                  ? (n.color.push(r), s.push(tF), i.push(tR.parse(t)))
                  : t.startsWith("var(")
                  ? (n.var.push(r), s.push("var"), i.push(t))
                  : (n.number.push(r), s.push(tj), i.push(parseFloat(t))),
                ++r,
                "${}"
              )
            )
        ...
        t$ = {
          test: function (t) {
            return (
              isNaN(t) &&
              "string" == typeof t &&
              (t.match(tb)?.length || 0) + (t.match(tL)?.length || 0) > 0
            );
          },
          parse: tI,
        ...
        resolveNoneKeyframes() {
          ...
          i.length &&
            (function (t, e, i) {
              ...
              if (n && i) for (let s of e) t[s] = t_(i, n);
            })(t, i, e);
        }
        measureInitialState() {
      ...
      class t3 {
        ...
        add(t) {
          return t2(this.subscriptions, t), () => t5(this.subscriptions, t);
        }
        notify(t, e, i) {
      ...
      class t6 {
        ...
        get() {
          return t4.current && t4.current.push(this), this.current;
        }
        getPrevious() {
          return this.prev;
        }
      ...
      let t7 = [...G, tR, t$],
        et = (t) => t7.find(q(t)),
        { schedule: ee } = th(queueMicrotask, !1),
        ei = {
          animation: [
            "animate",
            "variants",
        ...
        en = {};
      for (let t in ei) en[t] = { isEnabled: (e) => ei[t].some((t) => !!e[t]) };
      let es = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
        er = () => ({ x: es(), y: es() }),
        ea = () => ({ min: 0, max: 0 }),
        eo = () => ({ x: ea(), y: ea() });
      var el = i(8972);
      ...
      let em = [
        ...
        ef = ["initial", ...em];
      function eg(t) {
        return ec(t.animate) || ef.some((e) => ep(t[e]));
      }
      function ey(t) {
      ...
      class eT {
        ...
        mount(t) {
          (this.current = t),
            ...
            (this.shouldReduceMotion =
              ...
              ("always" === this.reducedMotionConfig || eh.current)),
        ...
        update(t, e) {
          ...
          (this.prevMotionValues = (function (t, e, i) {
            for (let n in e) {
              let s = e[n],
                r = i[n];
              if (tJ(s)) t.addValue(n, s);
              else if (tJ(r)) t.addValue(n, t8(s, { owner: t }));
              else if (r !== s)
                if (t.hasValue(n)) {
                  let e = t.getValue(n);
        ...
        readValue(t, e) {
          ...
          return (
            null != i &&
              ("string" == typeof i && (J(i) || tT(i))
                ? (i = parseFloat(i))
                : !et(i) && t$.test(e) && (i = t_(t, e)),
              this.setBaseTarget(t, tJ(i) ? i.get() : i)),
            tJ(i) ? i.get() : i
          );
        }
        setBaseTarget(t, e) {
        ...
        on(t, e) {
          return (
            this.events[t] || (this.events[t] = new t3()), this.events[t].add(e)
          );
        }
        notify(t, ...e) {
      ...
      let eb = (t, e) => (e && "number" == typeof t ? e.transform(t) : t),
        eS = {
          x: "translateX",
          y: "translateY",
          z: "translateZ",
      ...
      function eE(t, { style: e, vars: i }, n, s) {
        let r,
          a = t.style;
        for (r in e) a[r] = e[r];
      ...
      class ek extends eP {
        constructor() {
          super(...arguments), (this.type = "html"), (this.renderInstance = eE);
        }
        readValueFromInstance(t, e) {
          if (a.has(e)) return this.projection?.isProjecting ? m(e) : g(t, e);
          {
      ...
      let eR = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
        eL = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
      ...
      class eU extends eP {
        ...
        readValueFromInstance(t, e) {
          ...
          return (e = eB.has(e) ? e : eR(e)), t.getAttribute(e);
        }
        scrapeMotionValuesFromProps(t, e, i) {
          return eI(t, e, i);
        }
        ...
        renderInstance(t, e, i, n) {
          for (let i in (eE(t, e, void 0, n), e.attrs))
            t.setAttribute(eB.has(i) ? i : eR(i), e.attrs[i]);
        }
        mount(t) {
      ...
      var eW = i(5155),
        eY = i(869);
      let ez = (0, s.createContext)({ strict: !1 });
      var eH = i(1508);
      let eX = (0, s.createContext)({});
      function eK(t) {
      ...
      function eG(t, e, i) {
        for (let n in e) tJ(e[n]) || eC(n, i) || (t[n] = e[n]);
      }
      let e_ = () => ({ ...eq(), attrs: {} }),
        eZ = new Set([
          "animate",
      ...
      let e5 = (t) => (e, i) => {
        ...
        e3 = e5({ scrapeMotionValuesFromProps: eD, createRenderState: eq }),
        e9 = e5({ scrapeMotionValuesFromProps: eI, createRenderState: e_ }),
      ...
      let e8 = "data-" + eR("framerAppearId"),
        e7 = (0, s.createContext)({});
      var it = i(7494);
      function ie(t) {
        var e, i;
        ...
        function l(e, i) {
          ...
          let u,
            ...
            p = (function (t) {
              let { initial: e, animate: i } = (function (t, e) {
                if (eg(t)) {
                  ...
                  return {
                    initial: !1 === e || ep(e) ? e : void 0,
                    animate: ep(i) ? i : void 0,
                  };
                }
            ...
            m = o(e, c);
          if (!c && el.B) {
            (l = 0), (h = 0), (0, s.useContext)(ez).strict;
            let e = (function (t) {
              let { drag: e, layout: i } = en;
              if (!e && !i) return {};
              let n = { ...e, ...i };
              return {
                MeasureLayout:
            ...
            (u = e.MeasureLayout),
              (p.visualElement = (function (t, e, i, n, r) {
                let { visualElement: a } = (0, s.useContext)(eX),
                  o = (0, s.useContext)(ez),
                  l = (0, s.useContext)(e0.t),
                  h = (0, s.useContext)(eH.Q).reducedMotion,
                  u = (0, s.useRef)(null);
                (n = n || o.renderer),
                  !u.current &&
                    n &&
          ...
          return (0, eW.jsxs)(eX.Provider, {
            value: p,
            children: [
              u && p.visualElement
                ? (0, eW.jsx)(u, { visualElement: p.visualElement, ...d })
                : null,
                ...
                let o = (
                    e$(t)
                      ? function (t, e, i, n) {
                          ...
                          if (t.style) {
                            let e = {};
                            eG(e, t.style, t), (r.style = { ...e, ...r.style });
                          }
                          return r;
                        }
                      : function (t, e) {
                  ...
                  h = t !== s.Fragment ? { ...l, ...o, ref: i } : {},
                  { children: u } = e,
                  d = (0, s.useMemo)(() => (tJ(u) ? u.get() : u), [u]);
                return (0, s.createElement)(t, { ...h, children: d });
              })(
                t,
                e,
                ((r = p.visualElement),
      ...
      let ir = (t) => Array.isArray(t);
      function ia(t, e) {
        let i = t.getValue("willChange");
        if (tJ(i) && i.add) return i.add(e);
        if (!i && ta.WillChange) {
      ...
      let ix = (t, e) => {
          let i = iv(t),
            n = iv(e);
          if (!i || !n) return ip(t, e);
          let s = { ...i };
          return (t) => (
            (s.red = im(i.red, n.red, t)),
            (s.green = im(i.green, n.green, t)),
            (s.blue = im(i.blue, n.blue, t)),
            (s.alpha = S(i.alpha, n.alpha, t)),
            tC.transform(s)
          );
        },
      ...
      let iA = (t, e) => {
        ...
        return n.indexes.var.length === s.indexes.var.length &&
          ...
          ? (iw.has(t) && !s.values.length) || (iw.has(e) && !n.values.length)
            ? (function (t, e) {
                return iw.has(t)
                  ? (i) => (i <= 0 ? t : e)
                  : (i) => (i >= 1 ? e : t);
      ...
      let iE = (t) => {
          ...
          return {
            ...
            stop: () => td(e),
            now: () => (tc.isProcessing ? tc.timestamp : t1.now()),
          };
        },
        iV = (t, e, i = 10) => {
          let n = "",
      ...
      function iB(t = ik.visualDuration, e = ik.bounce) {
        let i,
          n =
            "object" != typeof t
            ...
            if (!iF(t, ij) && iF(t, iL))
              if (t.visualDuration) {
                ...
                let i = (function ({
                  ...
                  let a = 1 - e;
                  (a = O(ik.minDamping, ik.maxDamping, a)),
                    (t = O(ik.minDuration, ik.maxDuration, iu(t))),
                    a < 1
                      ? ((s = (e) => {
                          let n = e * a,
                            s = n * t;
                          return 0.001 - ((n - i) / iR(e, a)) * Math.exp(-s);
                        }),
                        (r = (e) => {
                          let n = e * a * t,
          ...
          x = 5 > Math.abs(y);
        if (
          (s || (s = x ? ik.restSpeed.granular : ik.restSpeed.default),
          r || (r = x ? ik.restDelta.granular : ik.restDelta.default),
          g < 1)
        ) {
          let t = iR(v, g);
          i = (e) =>
        ...
        let w = {
          ...
          toString: () => {
            let t = Math.min(iC(w), 2e4),
              e = iV((e) => w.next(t * e).value, t, 30);
            return t + "ms " + e;
          },
          toTransition: () => {},
        };
        ...
        let s = (e) =>
          (function (t, e, i, n, s) {
            let r,
              ...
              o = 0;
            do
              (r = iI((a = e + (i - e) / 2), n, s) - t) > 0 ? (i = a) : (e = a);
            while (Math.abs(r) > 1e-7 && ++o < 12);
            return a;
          })(e, 0, 1, t, i);
        return (t) => (0 === t || 1 === t ? t : iI(s(t), e, n));
      }
      let iN = iU(0.42, 0, 1, 1),
        i$ = iU(0, 0, 0.58, 1),
        iW = iU(0.42, 0, 0.58, 1),
        iY = (t) => Array.isArray(t) && "number" != typeof t[0],
        iz = (t) => (e) => e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
        iH = (t) => (e) => 1 - t(1 - e),
        iX = iU(0.33, 1.53, 0.69, 0.99),
        iK = iH(iX),
        iq = iz(iK),
        iG = (t) =>
          (t *= 2) < 1 ? 0.5 * iK(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
        i_ = (t) => 1 - Math.sin(Math.acos(t)),
        iZ = iH(i_),
        iQ = iz(i_),
        ...
        let r = iY(n) ? n.map(i2) : i2(n),
          ...
          o = (function (t, e, { clamp: i = !0, ease: n, mixer: s } = {}) {
            ...
            let o = (function (t, e, i) {
                ...
                for (let i = 0; i < r; i++) {
                  let r = s(t[i], t[i + 1]);
                  e && (r = il(Array.isArray(e) ? e[i] || tr : e, r)),
                    n.push(r);
                }
                return n;
              })(e, n, s),
            ...
            e,
            {
              ease: Array.isArray(r)
                ? r
                : e.map(() => r || iW).splice(0, e.length - 1),
            }
          );
        return {
      ...
      let i9 = (t) => null !== t;
      function i4(t, { repeat: e, repeatType: i = "loop" }, n, s = 1) {
        let r = t.filter(i9),
          a = s < 0 || (e && "loop" !== i && e % 2 == 1) ? 0 : r.length - 1;
        return a && void 0 !== n ? n : r[a];
      }
      let i6 = { decay: iO, inertia: iO, tween: i3, keyframes: i3, spring: iB };
      function i8(t) {
        "string" == typeof t.type && (t.type = i6[t.type]);
      }
      class i7 {
        constructor() {
          this.updateFinished();
      ...
      class ne extends i7 {
        constructor(t) {
          super(),
            ...
            (this.stop = () => {
              ...
              t && t.updatedAt !== t1.now() && this.tick(t1.now()),
                (this.isStopped = !0),
                "idle" !== this.state &&
        ...
        initAnimation() {
          ...
          o !== i3 &&
            "number" != typeof a[0] &&
            ((this.mixKeyframes = il(nt, iM(a[0], a[1]))), (a = [0, 100]));
        ...
        tick(t, e = !1) {
          ...
          return (
            P && p !== iO && (w.value = i4(h, this.options, f, this.speed)),
            m && m(w.value),
            P && this.finish(),
            w
          );
        ...
        get duration() {
          return iu(this.calculatedDuration);
        }
        get time() {
          return iu(this.currentTime);
        }
        set time(t) {
          (t = ih(t)),
            (this.currentTime = t),
        ...
        set speed(t) {
          this.updateTime(t1.now());
          let e = this.playbackSpeed !== t;
          (this.playbackSpeed = t), e && (this.time = iu(this.currentTime));
        }
        play() {
      ...
      let ns = nn(() => void 0 !== window.ScrollTimeline),
        ...
        no = ([t, e, i, n]) => `cubic-bezier(${t}, ${e}, ${i}, ${n})`,
        nl = {
          linear: "linear",
          ease: "ease",
          easeIn: "ease-in",
      ...
      class nu extends i7 {
        constructor(t) {
          ...
          (this.animation = (function (
            ...
            Array.isArray(d) && (u.easing = d), tl.value && id.waapi++;
            let c = {
              delay: n,
              duration: s,
            ...
            (this.animation.onfinish = () => {
              if (((this.finishedTime = this.time), !s)) {
                let t = i4(n, this.options, a, this.speed);
                this.updateMotionValue
                  ? this.updateMotionValue(t)
                  : (function (t, e, i) {
                      ni(e) ? t.style.setProperty(e, i) : (t.style[e] = i);
                    })(e, i, t),
        ...
        get time() {
          return iu(Number(this.animation.currentTime) || 0);
        }
        set time(t) {
          (this.finishedTime = null), (this.animation.currentTime = ih(t));
        }
        get speed() {
      ...
      let nd = { anticipate: iG, backInOut: iq, circInOut: iQ };
      class nc extends nu {
        constructor(t) {
          !(function (t) {
            "string" == typeof t.ease && t.ease in nd && (t.ease = nd[t.ease]);
          })(t),
            i8(t),
            super(t),
        ...
        updateMotionValue(t) {
          ...
          let a = new ne({ ...r, autoplay: !1 }),
            o = ih(this.finishedTime ?? this.time);
      ...
      let np = (t, e) =>
        ...
        nm = new Set(["opacity", "clipPath", "filter", "transform"]),
        nf = nn(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
      class ng extends i7 {
        constructor({
          autoplay: t = !0,
          delay: e = 0,
        ...
        onKeyframesResolved(t, e, i, n) {
          ...
          (this.resolvedAt = t1.now()),
            !(function (t, e, i, n) {
              ...
              ((ta.instantAnimations || !o) && h?.(i4(t, i, e)),
              (t[0] = t[t.length - 1]),
              (i.duration = 0),
              (i.repeat = 0));
          let u = {
            ...
            d =
              ...
              (function (t) {
                ...
                ? new nc({ ...u, element: u.motionValue.owner.current })
                : new ne(u);
      ...
      let ny = (t) => null !== t,
        nv = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
        nx = (t) => ({
          type: "spring",
          stiffness: 550,
        ...
        nb =
          ...
          (a) => {
            ...
            })(o) && Object.assign(u, nP(t, u)),
              u.duration && (u.duration = ih(u.duration)),
              u.repeatDelay && (u.repeatDelay = ih(u.repeatDelay)),
            ...
            return o.isSync ? new ne(u) : new ng(u);
          };
      function nS(t, e, { delay: i = 0, transitionOverride: n, type: s } = {}) {
        let {
          ...
          ia(t, e),
            n.start(
              nb(
                ...
                n,
                s,
                t.shouldReduceMotion && B.has(e) ? { type: !1 } : a,
                t,
                d
              )
            );
              ...
              tu.update(() => {
                a &&
                  (function (t, e) {
                    ...
                    for (let e in (s = { ...s, ...i })) {
                      var r;
                      let i = ir((r = s[e])) ? r[r.length - 1] || 0 : r;
                      t.hasValue(e)
                        ? t.getValue(e).set(i)
                        : t.addValue(e, t8(i));
                    }
      ...
      function nA(t, e, i = {}) {
        ...
        let r = n ? () => Promise.all(nS(t, n, i)) : () => Promise.resolve(),
          a =
                      ...
                      e.map(({ animation: e, options: i }) =>
                        (function (t, e, i = {}) {
                          ...
                          if ((t.notify("AnimationStart", e), Array.isArray(e)))
                            ...
                            let s =
                              "function" == typeof e ? ii(t, e, i.custom) : e;
                            n = Promise.all(nS(t, s, i));
                          }
                          return n.then(() => {
                ...
                function r(r) {
                  ...
                  for (let e = 0; e < nD; e++) {
                    ...
                    let w =
                        ...
                        "string" == typeof (p = g)
                          ? p !== c
                          : !!Array.isArray(p) && !nE(p, c)),
                      T =
                        w || (m === r && f.isActive && !x && y) || (e > d && y),
                      P = !1,
      ...
      function nH(t, e, i, n) {
        nz(t.x, e.x, i.x, n ? n.originX : void 0),
          nz(t.y, e.y, i.y, n ? n.originY : void 0);
      }
      function nX(t, e, i) {
        ...
        constructor(
          ...
          if (
            ...
            (this.updatePoint = () => {
              ...
              let t = n1(this.lastMoveEventInfo, this.history),
                e = null !== this.startEvent,
                i =
                  (function (t, e) {
                    return Math.sqrt(nZ(t.x, e.x) ** 2 + nZ(t.y, e.y) ** 2);
            ...
            (this.handlePointerMove = (t, e) => {
              (this.lastMoveEvent = t),
                (this.lastMoveEventInfo = nJ(e, this.transformPagePoint)),
          ...
          let a = nJ(nN(t), this.transformPagePoint),
            { point: o } = a,
            { timestamp: l } = tc;
          this.history = [{ ...o, timestamp: l }];
          let { onSessionStart: h } = e;
          h && h(t, n1(a, this.history)),
        ...
        return {
          ...
          velocity: (function (t, e) {
            ...
            for (
              ...
              i--;
            if (!n) return { x: 0, y: 0 };
            let r = iu(s.timestamp - n.timestamp);
      ...
      class n8 {
            ...
            t,
            {
              onSessionStart: (t) => {
                ...
                i ? this.pauseAnimation() : this.stopAnimation(),
                  e && this.snapToCursor(nN(t).point);
              },
              onStart: (t, e) => {
                let {
                  drag: i,
        ...
        updateAxis(t, e, i) {
          ...
          this.constraints &&
            ...
            (r = (function (t, { min: e, max: i }, n) {
              return (
                void 0 !== e && t < e
                  ? (t = n ? S(e, t, n.min) : Math.max(t, e))
                  : void 0 !== i &&
                    t > i &&
                    (t = n ? S(i, t, n.max) : Math.min(t, i)),
                t
              );
        ...
        resolveConstraints() {
          ...
          t && e6(t)
            ...
            ? (this.constraints = (function (
                ...
                return { x: n5(t.x, i, s), y: n5(t.y, e, n) };
              })(i.layoutBox, t))
            : (this.constraints = !1),
        ...
        resolveRefConstraints() {
          ...
          let r = (function (t, e, i) {
              let n = F(t, i),
                { scroll: s } = e;
              return s && (R(n.x, s.offset.x), R(n.y, s.offset.y)), n;
            })(n, s.root, this.visualElement.getTransformPagePoint()),
            a =
              ((t = s.layout.layoutBox), { x: n3(t.x, r.x), y: n3(t.y, r.y) });
          if (i) {
            let t = i(
              (function ({ x: t, y: e }) {
        ...
        startAnimation(t) {
          ...
          return Promise.all(
            nG((a) => {
              if (!n7(a, e, this.currentDirection)) return;
              let l = (o && o[a]) || {};
              r && (l = { min: 0, max: 0 });
              let h = {
                type: "inertia",
        ...
        startAxisValueAnimation(t, e) {
          ...
          return (
            ia(this.visualElement, t),
            i.start(nb(t, i, 0, e, this.visualElement, !1))
          );
        }
        stopAnimation() {
          nG((t) => this.getAxisMotionValue(t).stop());
        }
        pauseAnimation() {
          nG((t) => this.getAxisMotionValue(t).animation?.pause());
        }
        getAnimationState(t) {
          ...
          nG((t) => {
            ...
            if (e && !1 !== this.constraints) {
              ...
              n[t] = (function (t, e) {
                ...
                return (
                  s > n
                    ? (i = i5(e.min, e.max - n, t.min))
                    : n > s && (i = i5(t.min, t.max - s, e.min)),
                  O(0, 1, i)
                );
        ...
        addListeners() {
          ...
          let t = nW(this.visualElement.current, "pointerdown", (t) => {
      ...
      var sn = i(2082);
      let ss = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
      function sr(t, e) {
      ...
      let sa = {
          correct: (t, e) => {
            ...
            let i = sr(t, e.target.x),
              n = sr(t, e.target.y);
            return `${i}% ${n}%`;
          },
        },
        so = !1;
      class sl extends s.Component {
        componentDidMount() {
          let {
              visualElement: t,
              layoutGroup: e,
            ...
            { projection: s } = t;
          for (let t in su) (eV[t] = su[t]), x(t) && (eV[t].isCSSVariable = !0);
          s &&
      ...
      function sh(t) {
        let [e, i] = (0, sn.xQ)(),
          n = (0, s.useContext)(eY.L);
        return (0, eW.jsx)(sl, {
          ...t,
          layoutGroup: n,
          switchLayoutGroup: (0, s.useContext)(e7),
          isPresent: e,
          safeToRemove: i,
        });
      }
      ...
      var sd = i(6983);
      function sc(t) {
        return (0, sd.G)(t) && "ownerSVGElement" in t;
      }
      let sp = (t, e) => t.depth - e.depth;
      class sm {
        constructor() {
      ...
      let sf = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
        sg = sf.length,
        sy = (t) => ("string" == typeof t ? parseFloat(t) : t),
        sv = (t) => "number" == typeof t || z.test(t);
      function sx(t, e) {
      ...
      let sw = sP(0, 0.5, iZ),
        sT = sP(0.5, 0.95, tr);
      function sP(t, e, i) {
        return (n) => (n < t ? 0 : n > e ? 1 : i(i5(t, e, n)));
      }
      function sb(t, e) {
      ...
      function sE(t, e, [i, n, s], r, a) {
        !(function (t, e = 0, i = 1, n = 0.5, s, r = t, a = t) {
          if (
            ...
            return;
          let o = S(r.min, r.max, n);
          t === r && (o -= e),
            (t.min = sM(t.min, e, i, o, s)),
            (t.max = sM(t.max, e, i, o, s));
        })(t, e[i], e[n], e[s], e.scale, r, a);
      }
      let sV = ["x", "scaleX", "originX"],
        sC = ["y", "scaleY", "originY"];
      function sD(t, e, i, n) {
        sE(t.x, e, sV, i ? i.x : void 0, n ? n.x : void 0),
          sE(t.y, e, sC, i ? i.y : void 0, n ? n.y : void 0);
      }
      function sk(t) {
      ...
      function sY({
        ...
        return class {
            ...
            (this.id = s$++),
              ...
              (this.updateProjection = () => {
                (this.projectionUpdateScheduled = !1),
                  tl.value &&
                    (sU.nodes =
                      sU.calculatedTargetDeltas =
                      sU.calculatedProjections =
                        0),
                  this.nodes.forEach(sX),
                  this.nodes.forEach(sJ),
                  this.nodes.forEach(s0),
                  this.nodes.forEach(sK),
                  tl.addProjectionMetrics && tl.addProjectionMetrics(sU);
              }),
          ...
          addEventListener(t, e) {
            return (
              this.eventHandlers.has(t) || this.eventHandlers.set(t, new t3()),
          ...
          mount(e) {
            ...
            (this.isSVG = sc(e) && !(sc(e) && "svg" === e.tagName)),
              (this.instance = e);
                ...
                this.addEventListener(
                  ...
                  ({
                    ...
                    let r =
                      ...
                      l = !this.targetLayout || !sF(this.targetLayout, n),
                      h = !e && i;
                    if (
                      ...
                      let e = { ...is(r, "layout"), onPlay: a, onComplete: o };
          ...
          startUpdate() {
            !this.isUpdateBlocked() &&
              ((this.isUpdating = !0),
              this.nodes && this.nodes.forEach(s1),
              this.animationId++);
          }
          ...
          clearAllSnapshots() {
            this.nodes.forEach(sq), this.sharedNodes.forEach(s2);
          }
          ...
          removeElementScroll(t) {
            let e = eo();
            if ((sS(e, t), this.scroll?.wasRoot)) return e;
            for (let i = 0; i < this.path.length; i++) {
              ...
              n !== this.root &&
                s &&
                r.layoutScroll &&
                (s.wasRoot && sS(e, t), R(e.x, s.offset.x), R(e.y, s.offset.y));
            }
            return e;
          }
          applyTransform(t, e = !1) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              !e &&
                ...
                n.scroll &&
                n !== n.root &&
                j(i, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }),
                E(n.latestValues) && j(i, n.latestValues);
            }
            return E(this.latestValues) && j(i, this.latestValues), i;
          }
          removeTransform(t) {
            let e = eo();
            sS(e, t);
            ...
            return E(this.latestValues) && sD(e, this.latestValues), e;
          }
          setTargetDelta(t) {
            (this.targetDelta = t),
                ...
                if (this.attemptToResolveRelativeTarget) {
                  ...
                  1 !== this.animationProgress
                    ? ((this.relativeParent = t),
                      ...
                      (this.relativeTarget = eo()),
                      (this.relativeTargetOrigin = eo()),
                      nq(this.relativeTargetOrigin, this.target, t.target),
                      sS(this.relativeTarget, this.relativeTargetOrigin))
                    : (this.relativeParent = this.relativeTarget = void 0);
                }
                tl.value && sU.calculatedTargetDeltas++;
              }
            }
          }
          ...
          calcProjection() {
                ...
                for (let o = 0; o < a; o++) {
                  ...
                  (!a ||
                    ...
                    (n &&
                      ...
                      s.scroll &&
                      s !== s.root &&
                      j(t, { x: -s.scroll.offset.x, y: -s.scroll.offset.y }),
                    r && ((e.x *= r.x.scale), (e.y *= r.y.scale), k(t, r)),
                    n && E(s.latestValues) && j(t, s.latestValues));
                }
            ...
            this.projectionDelta && this.prevProjectionDelta
              ...
              tl.value && sU.calculatedProjections++;
          }
          hide() {
            this.isVisible = !1;
          }
                ...
                if (
                  ...
                  nq(
                    ...
                    i &&
                      ...
                      (c = i),
                      sL(h.x, c.x) && sL(h.y, c.y)) &&
                      (this.isProjectionDirty = !1),
                    i || (i = eo()),
                    sS(i, this.relativeTarget);
                }
                l &&
                  ((this.animationValues = r),
                  (function (t, e, i, n, s, r) {
                    s
                      ? ((t.opacity = S(0, i.opacity ?? 1, sw(n))),
                        (t.opacityExit = S(e.opacity ?? 1, 0, sT(n))))
                      : r && (t.opacity = S(e.opacity ?? 1, i.opacity ?? 1, n));
                    for (let s = 0; s < sg; s++) {
                      let r = `border${sf[s]}Radius`,
                        a = sx(e, r),
                        o = sx(i, r);
                      (void 0 !== a || void 0 !== o) &&
                        (a || (a = 0),
                        o || (o = 0),
                        0 === a || 0 === o || sv(a) === sv(o)
                          ? ((t[r] = Math.max(S(sy(a), sy(o), n), 0)),
                            (Y.test(o) || Y.test(a)) && (t[r] += "%"))
                          : (t[r] = o));
                    }
                    (e.rotate || i.rotate) &&
                      (t.rotate = S(e.rotate || 0, i.rotate || 0, n));
              ...
              (this.pendingAnimation = tu.update(() => {
                (ss.hasAnimatedSinceResize = !0),
                  ...
                  (this.currentAnimation = (function (t, e, i) {
                    let n = tJ(t) ? t : t8(t);
                    return n.start(nb("", n, e, i)), n.animation;
          ...
          registerSharedNode(t, e) {
            this.sharedNodes.has(t) || this.sharedNodes.set(t, new sI()),
          ...
          resetSkewAndRotation() {
            ...
            if (
              ...
              return;
            let n = {};
            i.z && sW("z", t, n, this.animationValues);
            for (let e = 0; e < sN.length; e++)
              sW(`rotate${sN[e]}`, t, n, this.animationValues),
                sW(`skew${sN[e]}`, t, n, this.animationValues);
          ...
          applyProjectionStyles(t, e) {
            ...
            if (this.needsReset) {
              (this.needsReset = !1),
                (t.visibility = ""),
                (t.opacity = ""),
                (t.pointerEvents = e2(e?.pointerEvents) || ""),
            ...
            eV)) {
              ...
              let { correct: i, applyTo: a, isCSSVariable: o } = eV[e],
            ...
            this.options.layoutId &&
              (t.pointerEvents =
                n === this ? e2(e?.pointerEvents) || "" : "none");
          }
          clearSnapshot() {
      ...
      function sH(t) {
        ...
        if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
          ...
          let o = er();
          r
            ? nH(o, t.applyTransform(n, !0), e.measuredBox)
            : nH(o, i, e.layoutBox);
          let l = !sR(a),
            h = !1;
          if (!t.resumeFrom) {
      ...
      function s3(t, e, i, n) {
        (t.min = S(e.min, i.min, n)), (t.max = S(e.max, i.max, n));
      }
      function s9(t) {
        return t.animationValues && void 0 !== t.animationValues.opacityExit;
      }
      let s4 = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        s6 = (t) =>
          "undefined" != typeof navigator &&
          navigator.userAgent &&
          navigator.userAgent.toLowerCase().includes(t),
        s8 = s6("applewebkit/") && !s6("chrome/") ? Math.round : tr;
      function s7(t) {
        (t.min = s8(t.min)), (t.max = s8(t.max));
      }
      function rt(t, e, i) {
        return (
          "position" === t ||
            ...
            (this.unmount = (function (t, e, i = {}) {
              let [n, s, r] = rr(t, i),
                a = (t) => {
                  ...
                  let r = (t) => {
                    ra(t) && (n(t), i.removeEventListener("pointerleave", r));
                  };
              ...
              t,
              (t, e) => (
                ro(this.node, e, "Start"), (t) => ro(this.node, t, "End")
              )
            ));
        }
        unmount() {}
      ...
      var ru = i(7351);
      let rd = (t, e) => !!e && (t === e || rd(t, e.parentElement)),
        rc = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]),
        rp = new WeakSet();
      function rm(t) {
        return (e) => {
          "Enter" === e.key && t(e);
      ...
      let rg = (t, e) => {
        ...
        let n = rm(() => {
          ...
          i.addEventListener("keyup", t, e),
            i.addEventListener("blur", () => rf(i, "cancel"), e);
        });
            ...
            (this.unmount = (function (t, e, i = {}) {
                  ...
                  let r = e(n, t),
                    a = (t, e) => {
                      window.removeEventListener("pointerup", o),
                        ...
                        ry(t) && "function" == typeof r && r(t, { success: e });
                    },
                    o = (t) => {
                      a(
                        t,
              ...
              return (
                n.forEach((t) => {
                  ...
                  (0, ru.s)(t)) &&
                    (t.addEventListener("focus", (t) => rg(t, s)),
                    rc.has(t.tagName) ||
                      -1 !== t.tabIndex ||
              ...
              (t, e) => (
                ...
                (t, { success: e }) => rv(this.node, t, e ? "End" : "Cancel")
              ),
        ...
        startObserver() {
          ...
          return (function (t, e, i) {
            let n = (function ({ root: t, ...e }) {
              ...
              return (
                n[s] ||
                  (n[s] = new IntersectionObserver(rb, { root: t, ...e })),
                n[s]
              );
            })(e);
            return (
      ...
      let rM = (function (t, e) {
        ...
        return new Proxy((t, e) => n(t, e), {
          get: (s, r) =>
            "create" === r
              ? n
              : (i.has(r) || i.set(r, ie(r, void 0, t, e)), i.get(r)),
        });
      })(
        {
          animation: { Feature: nj },
          exit: { Feature: nB },
          inView: { Feature: rA },
          tap: { Feature: rx },
          focus: { Feature: rh },
          hover: { Feature: rl },
          pan: { Feature: si },
          drag: { Feature: st, ProjectionNode: rs, MeasureLayout: sh },
          layout: { ProjectionNode: rs, MeasureLayout: sh },
        },
        (t, e) =>
          e$(t) ? new eU(e) : new ek(e, { allowProjection: t !== s.Fragment })
      );
    },
    2885: (t, e, i) => {
      i.d(e, { M: () => s });
    ...
    7494: (t, e, i) => {
      i.d(e, { E: () => s });
      var n = i(2115);
      let s = i(8972).B ? n.useLayoutEffect : n.useEffect;
    },
    8972: (t, e, i) => {
      i.d(e, { B: () => n });
    ...
    9265: (t, e, i) => {
      i.d(e, { A: () => n });
      let n = (0, i(9946).A)("circle-chevron-right", [
